...
public class JWTAutenticarFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public static final  int TOKEN_EXPRICAO = 600_00; // 600.00 = 10 min;
    public static final String TOKEN_SENHA = "ac9de649-45dc-4f46-ba91-92a03149f4fa";
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken( // Tratamento login User.
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = JWT.create().withSubject(usuarioData.getUsername())
                .withExpiresAt(new Date(System.currentTimeMillis() + TOKEN_EXPRICAO))
